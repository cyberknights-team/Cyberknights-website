    ...
    <div class="sidebar" data-color="black" data-image="assets/img/sidebar-4.jpg">
		...
		<?php
			...
			if(isset($_SESSION['admin'])){
				...
				echo '<li>';
				echo '
                    <a href="welcome.php?div=showEvents">
                        <i class="pe-7s-user"></i>
                        <p>Show Events</p>
                    </a>
                </li>';
...
echo '</tbody></table></div></div></div></div></div></div>';
	...
	echo "<input type='text' name='partition' value='".$entity->getPartitionKey()."' />";
	echo "<input type='text' name='rowKey' value='".$entity->getRowKey()."' />";
	echo "<td><div class='form-group'>
...
foreach($entities as $entity){
	...
	echo "<center><td>
	<a target='_blank' href='controller/download.php?container=".$entity->getPartitionKey()."&file=".$entity->getRowKey()."'>
